...
- <span class="fas fa-user-friends" aria-hidden="true"></span> Teaching Assistant: Yeonjoon (Philip) Choi, PhD student in Statistical Sciences
...
- <span class="fas fa-question" aria-hidden="true"></span> Questions about this course should be directed to the [Discussion board](https://q.utoronto.ca/courses/316929/) integrated within Quercus, which students can access by logging in with their UTORID.  One of the instructors will try to answer promptly.  Please see the Course Policies section for more detail. 
...
- Teaching Assistant: Virtual from 1:30-2:30pm on Wednesdays 

Zoom link: https://utoronto.zoom.us/j/4541840375 (Passcode: 234912)

- Professor: You are welcome to talk to the instructor after class or arrange a time to talk.  

Special office hours prior to the midterm exam will be arranged.  

Midterm Zoom link: https://utoronto.zoom.us/j/82105694037 (No Passcode)
<br>
...
- Questions and Answers can be posted on the [Quercus discussion board](https://q.utoronto.ca/courses/316929/).
...
The following people have contributed to the design of the course materials and website: Prof. Jesse Gronsbell (2020-2022) and Jianhui Gao (2022).
<br>
